...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col items-center px-10 pt-50">
            ...
            <FadeUp useInView delay={0.05}>
              <Card className="bg-background/30 gap-1 p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Drop a quick thought about anything you&apos;re exploring or are passionate about.
                </p>
              </Card>
            </FadeUp>
